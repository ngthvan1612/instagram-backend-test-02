...
@Repository
public class ExtendTreeRepositoryImpl extends ExtendEntityRepositoryBase<Tree> implements ExtendTreeRepository {
    @PersistenceContext
    ...
    @Override
    public List<Tree> searchTree(Map<String, String> queries) {
