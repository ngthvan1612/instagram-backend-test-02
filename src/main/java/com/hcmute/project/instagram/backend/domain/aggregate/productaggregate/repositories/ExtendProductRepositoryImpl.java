...
@Repository
public class ExtendProductRepositoryImpl extends ExtendEntityRepositoryBase<Product> implements ExtendProductRepository {
    @PersistenceContext
    ...
    @Override
    public List<Product> searchProduct(Map<String, String> queries) {
