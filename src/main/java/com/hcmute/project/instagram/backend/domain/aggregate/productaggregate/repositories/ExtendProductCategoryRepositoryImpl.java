...
@Repository
public class ExtendProductCategoryRepositoryImpl extends ExtendEntityRepositoryBase<ProductCategory> implements ExtendProductCategoryRepository {
    @PersistenceContext
    ...
    @Override
    public List<ProductCategory> searchProductCategory(Map<String, String> queries) {
        CriteriaBuilder criteriaBuilder = this.entityManager.getCriteriaBuilder();
        CriteriaQuery<ProductCategory> criteriaQuery = criteriaBuilder.createQuery(ProductCategory.class);
        Root<ProductCategory> productCategoryRoot = criteriaQuery.from(ProductCategory.class);
        ...
        return this.dynamicSearchEntity(
                ...
                criteriaQuery,
                productCategoryRoot,
                ProductCategory.class.getDeclaredFields()
        );
    }
}