...
@Repository
public class ExtendOrderRepositoryImpl extends ExtendEntityRepositoryBase<Order> implements ExtendOrderRepository {
    @PersistenceContext
    ...
    @Override
    public List<Order> searchOrder(Map<String, String> queries) {
